...
using MLDSA44Key = decltype(ML_DSA_44() + Function<function::Keygen>() + Block() + BlockDim<128>()); // Optional operator with default config

using MLDSA44Sign = decltype(ML_DSA_44() + Function<function::Sign>() + Block() + BlockDim<128>()); // Optional operator with default config

using MLDSA44Verify = decltype(ML_DSA_44() + Function<function::Verify>() + Block() + BlockDim<128>()); // Optional operator with default config
